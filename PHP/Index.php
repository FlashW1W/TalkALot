...
ul {
  ...
  <li><a href="Register.php">REGISTER</a></li>
      ...
      <div style="height: 300px">
         ...
         <p style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;text-align:justify;margin-left: 40px; margin-right: 40px">Pellentesque gravida justo sit amet dapibus tempus. Maecenas egestas aliquam velit, sed hendrerit felis malesuada nec.
